...
const navItemsByRole = {
  wakasek_kesiswaan: [
    ...
    { href: "/dashboard/manajemen-tata-tertib", icon: BookMarked, label: "Manajemen Tata Tertib" },
    { href: "/dashboard/mata-pelajaran", icon: BookCopy, label: "Mata Pelajaran" },
    { href: "/dashboard/jadwal-pelajaran", icon: CalendarClock, label: "Manajemen Jadwal" },
  ...
  guru_bk: [
    ...
    { href: "/dashboard/layanan-bimbingan-bk", icon: ClipboardList, label: "Layanan Bimbingan" },
